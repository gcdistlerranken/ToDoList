package com.google.distlergrace.todolist
...
import kotlinx.android.synthetic.main.to_row.view.*
...
class ToDoAdapter(val todos: List<String>) : RecyclerView.Adapter<ToDoAdapter.ToDoHolder>()
{
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ToDoHolder {
        return ToDoHolder(LayoutInflater.from(p0.context).inflate(R.layout.to_row, p0, false))
    }
